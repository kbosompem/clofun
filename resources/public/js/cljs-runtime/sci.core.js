...
var G__46490 = sci.core.new_var.cljs$core$IFn$_invoke$arity$3(name,null,null);
sci.impl.vars.unbind(G__46490);
...
var G__46495 = sci.core.new_dynamic_var.cljs$core$IFn$_invoke$arity$3(name,null,null);
sci.impl.vars.unbind(G__46495);
...
var new_m = (function (){var G__46506 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ns","ns",441598760),sci_ns,new cljs.core.Keyword(null,"name","name",1843675177),nm], null);
var G__46506__$1 = (cljs.core.truth_(macro)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46506,new cljs.core.Keyword(null,"macro","macro",-867863404),true):G__46506);
var G__46506__$2 = (cljs.core.truth_(doc)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46506__$1,new cljs.core.Keyword(null,"doc","doc",1913296891),doc):G__46506__$1);
var G__46506__$3 = (cljs.core.truth_(arglists)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46506__$2,new cljs.core.Keyword(null,"arglists","arglists",1661989754),arglists):G__46506__$2);
if(cljs.core.truth_(dynamic)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46506__$3,new cljs.core.Keyword(null,"dynamic","dynamic",704819571),dynamic);
} else {
return G__46506__$3;
}
})();
...
args_arr__5794__auto__.push((arguments[i__5770__auto___46572]));
...
var _STAR_unrestricted_STAR__orig_val__46520 = sci.impl.unrestrict._STAR_unrestricted_STAR_;
var _STAR_unrestricted_STAR__temp_val__46521 = true;
(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__temp_val__46521);

try{return sci.impl.vars.alter_var_root.cljs$core$IFn$_invoke$arity$2(v,f);
}finally {(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__orig_val__46520);
}}));

(sci.core.alter_var_root.cljs$core$IFn$_invoke$arity$variadic = (function (v,f,args){
var _STAR_unrestricted_STAR__orig_val__46522 = sci.impl.unrestrict._STAR_unrestricted_STAR_;
var _STAR_unrestricted_STAR__temp_val__46523 = true;
(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__temp_val__46523);

try{return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(sci.impl.vars.alter_var_root,v,f,args);
}finally {(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__orig_val__46522);
}}));

/** @this {Function} */
(sci.core.alter_var_root.cljs$lang$applyTo = (function (seq46516){
var G__46517 = cljs.core.first(seq46516);
var seq46516__$1 = cljs.core.next(seq46516);
var G__46518 = cljs.core.first(seq46516__$1);
var seq46516__$2 = cljs.core.next(seq46516__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46517,G__46518,seq46516__$2);
}));
...
var G__46542 = ex;
var G__46542__$1 = (((G__46542 == null))?null:cljs.core.ex_data(G__46542));
var G__46542__$2 = (((G__46542__$1 == null))?null:new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557).cljs$core$IFn$_invoke$arity$1(G__46542__$1));
if((G__46542__$2 == null)){
return null;
} else {
return sci.impl.callstack.stacktrace(G__46542__$2);
}
});
/**
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ns_map,p__46544){
var vec__46546 = p__46544;
var var_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46546,(0),null);
var var$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46546,(1),null);
...
sci.core.process_publics = (function sci$core$process_publics(publics,p__46549){
var map__46550 = p__46549;
var map__46550__$1 = cljs.core.__destructure_map(map__46550);
var exclude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46550__$1,new cljs.core.Keyword(null,"exclude","exclude",-1230250334));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ns_map,p__46551){
var vec__46552 = p__46551;
var var_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46552,(0),null);
var var$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46552,(1),null);
...
return sci.core.normalize_meta(cljs.core.select_keys(p1__46557_SHARP_,opts));
});
} else {
return (function (p1__46558_SHARP_){
return sci.core.normalize_meta(cljs.core.select_keys(p1__46558_SHARP_,new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"no-doc","no-doc",1559921891),new cljs.core.Keyword(null,"macro","macro",-867863404),new cljs.core.Keyword("sci","macro","sci/macro",-868536151),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"dynamic","dynamic",704819571)], null)));
});
...
var G__46564 = ctx;
var G__46565 = cljs.core.PersistentArrayMap.EMPTY;
var G__46566 = sym;
var fexpr__46563 = cljs.core.deref(sci.impl.utils.eval_resolve_state);
return (fexpr__46563.cljs$core$IFn$_invoke$arity$3 ? fexpr__46563.cljs$core$IFn$_invoke$arity$3(G__46564,G__46565,G__46566) : fexpr__46563.call(null,G__46564,G__46565,G__46566));
});
/**
