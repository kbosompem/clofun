...
var G__50667 = (new datascript.lru.LRU(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_value,k,v),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(gen_key,gen,k),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_gen,k,gen),(gen + (1)),limit));
...
var gen = lru.gen;
var limit = lru.limit;
var vec__50668 = cljs.core.first(gen_key);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50668,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50668,(1),null);
...
var datascript$lru$ICache$_get$dyn_50675 = (function (this$,key,compute_fn){
...
if((typeof datascript !== 'undefined') && (typeof datascript.lru !== 'undefined') && (typeof datascript.lru.t_datascript$lru50672 !== 'undefined')){
} else {
...
*/
datascript.lru.t_datascript$lru50672 = (function (limit,_STAR_impl,meta50673){
this.limit = limit;
...
(datascript.lru.t_datascript$lru50672.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_50674,meta50673__$1){
var self__ = this;
var _50674__$1 = this;
return (new datascript.lru.t_datascript$lru50672(self__.limit,self__._STAR_impl,meta50673__$1));
}));

(datascript.lru.t_datascript$lru50672.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_50674){
var self__ = this;
var _50674__$1 = this;
return self__.meta50673;
}));

(datascript.lru.t_datascript$lru50672.prototype.datascript$lru$ICache$ = cljs.core.PROTOCOL_SENTINEL);

(datascript.lru.t_datascript$lru50672.prototype.datascript$lru$ICache$_get$arity$3 = (function (this$,key,compute_fn){
var self__ = this;
var this$__$1 = this;
...
(datascript.lru.t_datascript$lru50672.getBasis = (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"limit","limit",284709164,null),new cljs.core.Symbol(null,"*impl","*impl",1858309677,null),new cljs.core.Symbol(null,"meta50673","meta50673",-2090283877,null)], null);
}));

(datascript.lru.t_datascript$lru50672.cljs$lang$type = true);

(datascript.lru.t_datascript$lru50672.cljs$lang$ctorStr = "datascript.lru/t_datascript$lru50672");

(datascript.lru.t_datascript$lru50672.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"datascript.lru/t_datascript$lru50672");
}));

/**
 * Positional factory function for datascript.lru/t_datascript$lru50672.
 */
datascript.lru.__GT_t_datascript$lru50672 = (function datascript$lru$cache_$___GT_t_datascript$lru50672(limit__$1,_STAR_impl__$1,meta50673){
