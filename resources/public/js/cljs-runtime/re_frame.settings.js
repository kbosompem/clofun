...
re_frame.settings.reg_global_interceptor = (function re_frame$settings$reg_global_interceptor(p__49269){
var map__49270 = p__49269;
var map__49270__$1 = cljs.core.__destructure_map(map__49270);
var interceptor = map__49270__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49270__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__49271_SHARP_));
}),global_interceptors));
}));
}));
