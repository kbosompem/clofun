...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__50598 = cljs.core.second(format);
var G__50600 = format_params;
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__50613){
var map__50617 = p__50613;
var map__50617__$1 = cljs.core.__destructure_map(map__50617);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50617__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50617__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50617__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50625,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50625,(1),null);
var fexpr__50628_50671 = (cljs.core.truth_(ok)?h:e);
 ...
 */
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__50629){
var map__50630 = p__50629;
var map__50630__$1 = cljs.core.__destructure_map(map__50630);
var opts = map__50630__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50630__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50630__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50630__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50630__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50630__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
