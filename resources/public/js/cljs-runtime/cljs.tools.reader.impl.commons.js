...
var G__27945 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__27945;
continue;
} else {
return ch;
...
var vec__27923 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27923,(0),null);
return (match === s);
});
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq27935){
...
return (function() { 
var G__27963__delegate = function (rdr,_){
...
var G__27963 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__27964__i = 0, G__27964__a = new Array(arguments.length -  1);
while (G__27964__i < G__27964__a.length) {G__27964__a[G__27964__i] = arguments[G__27964__i + 1]; ++G__27964__i;}
  _ = new cljs.core.IndexedSeq(G__27964__a,0,null);
} 
return G__27963__delegate.call(this,rdr,_);};
G__27963.cljs$lang$maxFixedArity = 1;
G__27963.cljs$lang$applyTo = (function (arglist__27966){
var rdr = cljs.core.first(arglist__27966);
var _ = cljs.core.rest(arglist__27966);
return G__27963__delegate(rdr,_);
});
