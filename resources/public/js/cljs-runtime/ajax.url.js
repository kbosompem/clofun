...
ajax.url.key_value_pair_to_str = (function ajax$url$key_value_pair_to_str(p__50204){
var vec__50205 = p__50204;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50205,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50205,(1),null);
...
var vec_key_encode = (function (){var G__50212 = (function (){var or__5045__auto__ = vec_strategy;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50212__$1)].join('')));
 ...
 */
ajax.url.param_to_key_value_pairs = (function ajax$url$param_to_key_value_pairs(vec_key_transform,prefix,p__50217){
var vec__50218 = p__50217;
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50218,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50218,(1),null);
...
(ajax.url.url_request_format.cljs$core$IFn$_invoke$arity$1 = (function (p__50253){
var map__50254 = p__50253;
var map__50254__$1 = cljs.core.__destructure_map(map__50254);
var vec_strategy = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50254__$1,new cljs.core.Keyword(null,"vec-strategy","vec-strategy",1843221372));
