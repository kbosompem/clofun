...
var G__49041 = o;
reagent.impl.template.goog$module$goog$object.set(G__49041,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__49042 = o;
reagent.impl.template.goog$module$goog$object.set(G__49042,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__49043 = props;
var G__49043__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__49043,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__49043);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__49043__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__49044 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__49044,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__49044;
}
})(),id_class);
...
var G__49045 = (cljs.core.count(argv) - first_child);
switch (G__49045) {
case (0):
...
var vec__49046 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49046,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49046,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49046,(2),null);
...
var temp__5808__auto___49076 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___49076 == null)){
} else {
var key_49077 = temp__5808__auto___49076;
(jsprops.key = key_49077);
}
...
var temp__5808__auto___49078 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___49078 == null)){
} else {
var key_49079 = temp__5808__auto___49078;
(jsprops.key = key_49079);
}
...
var temp__5808__auto___49080 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___49080 == null)){
} else {
var key_49081 = temp__5808__auto___49080;
(jsprops.key = key_49081);
}
...
var temp__5808__auto___49086 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___49086 == null)){
} else {
var key_49087 = temp__5808__auto___49086;
(jsprops.key = key_49087);
}
...
var temp__5808__auto___49088 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___49088 == null)){
} else {
var key_49089 = temp__5808__auto___49088;
(jsprops.key = key_49089);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49049_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__49049_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__49050 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49050,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49050,(1),null);
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template49058 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template49058 = (function (opts,id,fn_to_element,parse_fn,meta49059){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template49058.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_49060,meta49059__$1){
var self__ = this;
var _49060__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template49058(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta49059__$1));
}));

(reagent.impl.template.t_reagent$impl$template49058.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_49060){
var self__ = this;
var _49060__$1 = this;
return self__.meta49059;
}));

(reagent.impl.template.t_reagent$impl$template49058.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template49058.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template49058.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template49058.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template49058.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template49058.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta49059","meta49059",592533647,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template49058.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template49058.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template49058");

(reagent.impl.template.t_reagent$impl$template49058.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template49058");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template49058.
 */
reagent.impl.template.__GT_t_reagent$impl$template49058 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template49058(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta49059){
return (new reagent.impl.template.t_reagent$impl$template49058(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta49059));
});

}

return (new reagent.impl.template.t_reagent$impl$template49058(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
