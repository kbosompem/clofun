...
var sci$impl$types$IBox$setVal$dyn_38638 = (function (_this,_v){
...
return sci$impl$types$IBox$setVal$dyn_38638(_this,_v);
}
});

var sci$impl$types$IBox$getVal$dyn_38639 = (function (_this){
var x__5393__auto__ = (((_this == null))?null:_this);
...
return sci$impl$types$IBox$getVal$dyn_38639(_this);
}
});
...
var sci$impl$types$IReified$getInterfaces$dyn_38640 = (function (_){
...
return sci$impl$types$IReified$getInterfaces$dyn_38640(_);
}
});

var sci$impl$types$IReified$getMethods$dyn_38641 = (function (_){
var x__5393__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$IReified$getMethods$dyn_38641(_);
}
});

var sci$impl$types$IReified$getProtocols$dyn_38642 = (function (_){
var x__5393__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$IReified$getProtocols$dyn_38642(_);
}
});
...
var sci$impl$types$SciTypeInstance$_get_type$dyn_38643 = (function (_){
var x__5393__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$SciTypeInstance$_get_type$dyn_38643(_);
}
});

var sci$impl$types$SciTypeInstance$_mutate$dyn_38644 = (function (_,k,v){
var x__5393__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$SciTypeInstance$_mutate$dyn_38644(_,k,v);
}
});
...
var len__5769__auto___38645 = arguments.length;
var i__5770__auto___38646 = (0);
while(true){
if((i__5770__auto___38646 < len__5769__auto___38645)){
args__5775__auto__.push((arguments[i__5770__auto___38646]));

var G__38647 = (i__5770__auto___38646 + (1));
i__5770__auto___38646 = G__38647;
continue;
} else {
}
break;
...
var or__5045__auto____$2 = (function (){var G__38597 = x;
var G__38597__$1 = (((G__38597 == null))?null:cljs.core.meta(G__38597));
if((G__38597__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(G__38597__$1);
}
})();
...
/** @this {Function} */
(sci.impl.types.type_impl.cljs$lang$applyTo = (function (seq38590){
var G__38591 = cljs.core.first(seq38590);
var seq38590__$1 = cljs.core.next(seq38590);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38591,seq38590__$1);
}));
...
var or__5045__auto____$1 = (function (){var G__38601 = x;
var G__38601__$1 = (((G__38601 == null))?null:cljs.core.meta(G__38601));
if((G__38601__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(G__38601__$1);
}
})();
if(cljs.core.truth_(or__5045__auto____$1)){
return or__5045__auto____$1;
...
var sci$impl$types$Stack$stack$dyn_38651 = (function (this$){
...
return sci$impl$types$Stack$stack$dyn_38651(this$);
}
});
...
(sci.impl.types.NodeR.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k38603,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__38607 = k38603;
var G__38607__$1 = (((G__38607 instanceof cljs.core.Keyword))?G__38607.fqn:null);
switch (G__38607__$1) {
case "f":
return self__.f;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k38603,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__38610){
var vec__38611 = p__38610;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38611,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38611,(1),null);
...
(sci.impl.types.NodeR.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__38602){
var self__ = this;
var G__38602__$1 = this;
return (new cljs.core.RecordIter((0),G__38602__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"f","f",-1597136552),new cljs.core.Keyword(null,"stack","stack",-793405930)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(sci.impl.types.NodeR.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this38604,other38605){
var self__ = this;
var this38604__$1 = this;
return (((!((other38605 == null)))) && ((((this38604__$1.constructor === other38605.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38604__$1.f,other38605.f)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38604__$1.stack,other38605.stack)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38604__$1.__extmap,other38605.__extmap)))))))));
}));
...
(sci.impl.types.NodeR.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k38603){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k38603);

}
}));

(sci.impl.types.NodeR.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__38602){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__38628 = cljs.core.keyword_identical_QMARK_;
var expr__38629 = k__5352__auto__;
if(cljs.core.truth_((pred__38628.cljs$core$IFn$_invoke$arity$2 ? pred__38628.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"f","f",-1597136552),expr__38629) : pred__38628.call(null,new cljs.core.Keyword(null,"f","f",-1597136552),expr__38629)))){
return (new sci.impl.types.NodeR(G__38602,self__.stack,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__38628.cljs$core$IFn$_invoke$arity$2 ? pred__38628.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"stack","stack",-793405930),expr__38629) : pred__38628.call(null,new cljs.core.Keyword(null,"stack","stack",-793405930),expr__38629)))){
return (new sci.impl.types.NodeR(self__.f,G__38602,self__.__meta,self__.__extmap,null));
} else {
return (new sci.impl.types.NodeR(self__.f,self__.stack,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__38602),null));
}
}
}));
...
(sci.impl.types.NodeR.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__38602){
var self__ = this;
var this__5342__auto____$1 = this;
return (new sci.impl.types.NodeR(self__.f,self__.stack,G__38602,self__.__extmap,self__.__hash));
}));
 ...
 */
sci.impl.types.map__GT_NodeR = (function sci$impl$types$map__GT_NodeR(G__38606){
var extmap__5385__auto__ = (function (){var G__38632 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__38606,new cljs.core.Keyword(null,"f","f",-1597136552),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"stack","stack",-793405930)], 0));
if(cljs.core.record_QMARK_(G__38606)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__38632);
} else {
return G__38632;
}
})();
return (new sci.impl.types.NodeR(new cljs.core.Keyword(null,"f","f",-1597136552).cljs$core$IFn$_invoke$arity$1(G__38606),new cljs.core.Keyword(null,"stack","stack",-793405930).cljs$core$IFn$_invoke$arity$1(G__38606),null,cljs.core.not_empty(extmap__5385__auto__),null));
});

sci.impl.types.eval = (function sci$impl$types$eval(expr,ctx,bindings){
if((expr instanceof sci.impl.types.NodeR)){
var fexpr__38633 = expr.f;
return (fexpr__38633.cljs$core$IFn$_invoke$arity$3 ? fexpr__38633.cljs$core$IFn$_invoke$arity$3(expr,ctx,bindings) : fexpr__38633.call(null,expr,ctx,bindings));
} else {
return expr;
}
});
...
var sci$impl$types$HasName$getName$dyn_38667 = (function (_){
var x__5393__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$HasName$getName$dyn_38667(_);
}
});
