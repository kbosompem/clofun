...
var i_30814 = (self__.level + (1));
while(true){
if((i_30814 <= (new_level + (1)))){
(update[i_30814] = self__.header);

var G__30816 = (i_30814 + (1));
i_30814 = G__30816;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_30819 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_30819[i]));
} else {
x__$2.forward.push((((i < links_30819.length))?(links_30819[i]):null));
}

if((i < links_30819.length)){
(links_30819[i] = x__$2);
} else {
links_30819.push(x__$2);
}
...
var i_30831 = (0);
while(true){
if((i_30831 <= self__.level)){
var links_30832 = (update[i_30831]).forward;
if((x__$1 === (((i_30831 < links_30832.length))?(links_30832[i_30831]):null))){
(links_30832[i_30831] = (x__$1.forward[i_30831]));

var G__30834 = (i_30831 + (1));
i_30831 = G__30834;
continue;
} else {
var G__30835 = (i_30831 + (1));
i_30831 = G__30835;
continue;
}
} else {
...
var G__30837 = nx;
var G__30838 = (level__$1 - (1));
x = G__30837;
level__$1 = G__30838;
continue;
} else {
var G__30839 = x;
var G__30840 = (level__$1 - (1));
x = G__30839;
level__$1 = G__30840;
continue;
}
