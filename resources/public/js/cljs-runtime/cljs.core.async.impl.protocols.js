...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_28040 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_28040(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_28041 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_28041(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28044 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28044(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28045 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28045(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_28050 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_28050(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_28052 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_28052(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_28062 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_28062(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28068 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28068(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28078 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28078(b);
}
});
...
var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28091 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28091(b);
}
});
