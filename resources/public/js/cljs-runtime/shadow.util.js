...
var len__5769__auto___31065 = arguments.length;
var i__5770__auto___31066 = (0);
while(true){
if((i__5770__auto___31066 < len__5769__auto___31065)){
args_arr__5794__auto__.push((arguments[i__5770__auto___31066]));

var G__31067 = (i__5770__auto___31066 + (1));
i__5770__auto___31066 = G__31067;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq31026){
...
var G__31030 = cljs.core.first(seq31026__$3);
var seq31026__$4 = cljs.core.next(seq31026__$3);
var G__31031 = cljs.core.first(seq31026__$4);
var seq31026__$5 = cljs.core.next(seq31026__$4);
var G__31032 = cljs.core.first(seq31026__$5);
var seq31026__$6 = cljs.core.next(seq31026__$5);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31027,G__31028,G__31029,G__31030,G__31031,G__31032,seq31026__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__31051){
var vec__31052 = p__31051;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31052,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31052,(1),null);
